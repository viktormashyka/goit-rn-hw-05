...
const ProfileScreen = ({ navigation }: { navigation: NavigationProp<any> }) => {
  ...
  const handleLogOut = () => {
    console.log("TODO: add functionality for logout"); // Update this line after refactoring
  };
    ...
    <View style={styles.container}>
      <View style={styles.container}>
        ...
        <View style={styles.formContainer}>
          ...
          <Text style={[styles.title, { marginBottom: 32 }]}>Nickname</Text>
          {/* TODO: add nickname from data */}
          <FlatList
